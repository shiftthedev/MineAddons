...
public class CustomExplosion extends Explosion
{
    ...
    private final float explosionStrenght;
    private final List<BlockPos> affectedBlockPositions;
    private final Map<EntityPlayer, Vec3d> playerKnockbackMap;
    private final Vec3d position;

    @SideOnly(Side.CLIENT)
    public CustomExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, float strenght, List<BlockPos> affectedPositions)
    {
        this(worldIn, entityIn, x, y, z, size, strenght, false, true, affectedPositions);
    }
    ...
    public CustomExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, float strenght, boolean flaming, boolean smoking)
    {
        ...
        this.explosionStrenght = strenght;
        this.explosionX = x;
        this.explosionY = y;
        this.explosionZ = z;
    ...
    public void doExplosionA()
    {
        ...
        for (int k2 = 0; k2 < list.size(); ++k2)
        {
            ...
            {
                double d12 = this.explosionStrenght;
                ...
                if (d12 <= 1.0D)
                {
                    ...
                    if (d13 != 0.0D)
                    {
                        ...
                        double d10 = d12;
                        entity.attackEntityFrom(DamageSource.causeExplosionDamage(this), (float)d10);
                        double d11 = 1.0D;
