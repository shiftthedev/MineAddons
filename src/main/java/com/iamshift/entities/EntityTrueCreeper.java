...
import com.iamshift.entities.ais.EntityAITrueCreeperSwell;
...
public class EntityTrueCreeper extends EntityMob implements IMobChanger
{
	...
	public EntityTrueCreeper(World worldIn) 
	{
		super(worldIn);
	...
	protected void initEntityAI() 
	{
		...
		this.tasks.addTask(2, new EntityAITrueCreeperSwell(this));
		this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityOcelot.class, 6.0F, 1.0D, 1.2D));
		this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityPeaceCreeper.class, 6.0F, 1.0D, 1.2D));
	...
	{
		EntityPeaceCreeper creeper = new EntityPeaceCreeper(worldObj);
