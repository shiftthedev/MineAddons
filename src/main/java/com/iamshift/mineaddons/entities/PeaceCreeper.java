...
import com.iamshift.mineaddons.utils.IMobChanger;
...
public class PeaceCreeper extends EntityTameable implements IMobChanger
{
	...
	public PeaceCreeper(World worldIn) 
	{
		super(worldIn);
	...
	{
		if(!this.isTamed() && Config.truecreeper)
		{
			TrueCreeper creeper = new TrueCreeper(worldObj);
